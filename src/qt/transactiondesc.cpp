...
{
    QString strHTML;
    QString explorer(fTestNet ? "http://testnet.shadowchain.info/" : "http://127.0.0.1/");
    ...
    if (wtx.mapValue.count("to") && !wtx.mapValue["to"].empty())
    {
        ...
        strHTML += tr("To") ; //+ ":</b> <a href='"+explorer + "address/" + GUIUtil::HtmlEscape(strAddress) + "' target='_blank'>";
        strHTML += ":";
