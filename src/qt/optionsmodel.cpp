...
void OptionsModel::Init()
{
    ...
    fAutoRedeemBitcoin = settings.value("fAutoRedeemBitcoin", false).toBool();
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case AutoRedeemBitcoin:
            return fAutoRedeemBitcoin;
        case MinRingSize:
            return nMinRingSize;
        case MaxRingSize:
            return nMaxRingSize;
...
QString OptionsModel::optionIDName(int row)
{
    ...
    case AutoRedeemBitcoin: return "AutoRedeemBitcoin";
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DisplayAddresses:
            ...
            emit displayUnitChanged(settings.value("nDisplayUnit", BitcoinUnits::BTC).toInt());
            break;
        case DetachDatabases: {
        ...
        case AutoRingSize: {
            ...
            break;
        case AutoRedeemBitcoin: {
            fAutoRedeemBitcoin = value.toBool();
            settings.setValue("fAutoRedeemBitcoin", fAutoRedeemBitcoin);
            }
            break;
        case MinRingSize: {
...
bool OptionsModel::getAutoRedeemBitcoin() { return fAutoRedeemBitcoin; }
