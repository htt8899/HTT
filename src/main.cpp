...
unsigned int nStakeMinAge       = 365 * 24 * 60 * 60;      // 8 hours
...
const string strMessageMagic = "HealthierthriceChain Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        LogPrintf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "HealthierthriceChain", CClientUIInterface::BTN_OK | CClientUIInterface::ICON_WARNING | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
{
    RenameThread("HealthierthriceChain-loadblk");
    CImportingNow imp;
