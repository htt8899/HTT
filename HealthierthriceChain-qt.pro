...
build_macosx64 {
    QMAKE_TARGET_BUNDLE_PREFIX = co.HealthierthriceChain
    BOOST_LIB_SUFFIX=-mt
...
macx:ICON = src/qt/res/icons/HealthierthriceChain.icns
macx:TARGET = "HealthierthriceChain"
