...
// test_HealthierthriceChain --log_level=all  --run_test=smsg_tests
...
BOOST_AUTO_TEST_CASE(smsg_test)
{
    ...
    const std::string sTestMessage =
        "HealthierthriceChain is a STATE OF THE ART, Proof of Stake crypto currency, utilizing cutting edge technology, "
