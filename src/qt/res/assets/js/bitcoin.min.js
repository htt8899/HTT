...
function receivePageInit() {
    var e = [{
        name: bridge.translateHtmlString("Copy&nbsp;Address"),
        fun: function() {
            copy("#receive .footable .selected .address")
        }
    },
    {
        name:  bridge.translateHtmlString("Copy&nbsp;Label"),
        fun: function() {
            copy("#receive .footable .selected .label2")
        }
    },
    {
        name:  bridge.translateHtmlString("Copy&nbsp;Public&nbsp;Key"),
        fun: function() {
            copy("#receive .footable .selected .pubkey")
        }
    },
    {
        name:  bridge.translateHtmlString("Edit"),
        fun: function() {
...
function addSendAddress() {
    var e, t, a, n;
    if (e = $("#new-send-label").val(), t = $("#new-send-address").val(), a = bridge.getAddressLabel(t), "" !== a) return $("#new-send-address-error").text(bridge.translateHtmlString('Error: address already in addressbook under "') + a + '"'),
    void $("#new-send-address").addClass("inputError");
    var s = 0;
    if (n = bridge.newAddress(e, s, t, !0), "" === n) {
        var o = bridge.lastAddressError();
        $("#new-send-address-error").text(bridge.translateHtmlString("Error: ") + o),
...
function addressBookInit() {
    ...
    {
        name: bridge.translateHtmlString("Delete"),
        fun: function() {
...
function appendAddresses(e) {
    ...
    e.forEach(function(e) {
        ...
        function(e) {
            e.stopPropagation(),
            updateValue($(this))
        }).attr("data-title", bridge.translateHtmlString("Double click to edit")).tooltip()) : ($("#" + e.address + " .label2").data("value", e.label_value).text(e.label), $("#" + e.address + " .pubkey").text(e.pubkey))
    });
...
function transactionPageInit() {
    var e = [{
        name: bridge.translateHtmlString("Copy&nbsp;Amount"),
        fun: function() {
            copy("#transactions .footable .selected .amount", "data-value")
        }
    },
    {
        name: bridge.translateHtmlString("Copy&nbsp;transaction&nbsp;ID"),
        fun: function() {
            copy("#transactions .footable .selected", "id")
        }
    },
    {
        name: bridge.translateHtmlString("Edit&nbsp;label"),
        fun: function() {
            $("#transactions .footable .selected .editable").dblclick()
        }
    },
    {
        name: bridge.translateHtmlString("Show&nbsp;transaction&nbsp;details"),
        fun: function() {
...
function bindTransactionTableEvents() {
    ...
    function(e) {
        ...
        e.preventDefault(),
        updateValue($(this))
    }).attr("data-title", bridge.translateHtmlString("Double click to edit")).tooltip()
}
...
function shadowChatInit() {
    var e = [{
        name: bridge.translateHtmlString("Send&nbsp;HealthierthriceChain"),
        fun: function() {
            clearRecipients(),
    ...
    {
        name: bridge.translateHtmlString("Private&nbsp;Message"),
        fun: function() {
            $("#message-text").focus()
        }
    }];
    ...
    e = [{
        name: bridge.translateHtmlString("Copy&nbsp;Selected"),
        fun: function() {
    ...
    {
        name: bridge.translateHtmlString("Paste"),
        fun: function() {
            paste("#pasteTo");
            var e = $("#message-text")[0];
...
function openConversation(e, t) {
    function a(e) {
        return micromarkdown.parse(emojione.toImage(e)).replace(/<a class="mmd_HealthierthriceChainh" href="(.+)">(.+)<\/a>/g, '<a class="mmd_HealthierthriceChain" onclick="return confirmConversationOpenLink()" target="_blank" href="$1" data-title="$1">$1</a>')
    }
...
function dumpStrings() {
    function e(e) {
        return 'QT_TRANSLATE_NOOP("BitcoinBridge", "' + e + '"),\n'
    }
    var t = "";
    ...
    $("[data-title]").each(function(a) {
        var n = e($(this).attr("data-title").trim());
        t.indexOf(n) == -1 && (t += n)
    }),
    console.log(t)
}
...
$(function() {
    ...
    function(e) {
        e.stopPropagation(),
        updateValue($(this))
    }).attr("data-title", bridge.translateHtmlString("Double click to edit %column%")),
...
overviewPage = {
    init: function() {
        ...
        this.bitcoinBal = $(".bitcoin_balance"),
    ...
    updateBalance: function(e, t, a, n, s) {
        void 0 == e ? (e = this.balance.data("orig"), t = this.bitcoinBal.data("orig"), a = this.stake.data("orig"), n = this.unconfirmed.data("orig"), s = this.immature.data("orig")) : (this.balance.data("orig", e), this.bitcoinBal.data("orig", t), this.stake.data("orig", a), this.unconfirmed.data("orig", n), this.immature.data("orig", s)),
        this.formatValue("balance", e),
        this.formatValue("bitcoinBal", t),
