...
int64_t CChainParams::GetProofOfWorkReward(int nHeight, int64_t nFees) const
{
    ...
    if (nHeight >= 1 && nHeight <= 20)
        nSubsidy = (NetworkID() == CChainParams::TESTNET ? 10000 : 50000000) * COIN;
...
int64_t CChainParams::GetProofOfStakeReward(const CBlockIndex* pindexPrev, int64_t nCoinAge, int64_t nFees) const
{
	...
	if (pindexPrev->nHeight <= 500000)
		nSubsidy = nCoinAge * COIN_YEAR_REWARD * 0 / 365 ;
...
public:
    CBaseChainParams() {
        const char* pszTimestamp = "HealthierthriceChain TO DA MOON!";
        CTransaction txNew;
        ...
        vSeeds.push_back(CDNSSeedData("162.219.28.90",  "162.219.28.90"));
        vSeeds.push_back(CDNSSeedData("162.219.25.202",  "162.219.25.202"));
        vSeeds.push_back(CDNSSeedData("64.187.229.58",  "64.187.229.58"));
    }
...
public:
    CMainParams() {
        ...
        nFirstPosv2Block = 5000000;
        nFirstPosv3Block = 5000000;
        ...
        assert(hashGenesisBlock == uint256("0xf76595e9f0d15a8c9d8ab2afd6bfe743c5bbd149766f48e2e6e07848b2dd3c4a"));
        assert(genesis.hashMerkleRoot == uint256("0x4e541324ddf281d9d6af04730f1f9f7f8860bae550d4398e7919ea0fc4913edc"));
