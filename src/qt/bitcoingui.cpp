    ...
    nWeight(0)
{
    ...
    resize(1280, 720);
    setWindowTitle(tr("HealthierthriceChain") + " - " + tr("Client"));
#ifndef Q_OS_MAC
    qApp->setWindowIcon(QIcon(":icons/HealthierthriceChain"));
    setWindowIcon(QIcon(":icons/HealthierthriceChain"));
#else
...
#ifdef Q_OS_WIN
    QFile html("C:/HealthierthriceChain/index.html");
#else
    QFile html("/opt/HealthierthriceChain/index.html");
#endif
...
void BitcoinGUI::pageLoaded(bool ok)
{
...
void BitcoinGUI::addJavascriptObjects()
{
    documentFrame->addToJavaScriptWindowObject("bridge", bridge);

}

void BitcoinGUI::urlClicked(const QUrl & link)
{
...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/HealthierthriceChain"), tr("&About HealthierthriceChain"), this);
    aboutAction->setToolTip(tr("Show information about HealthierthriceChain"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for HealthierthriceChain"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/HealthierthriceChain"), tr("&Show / Hide"), this);
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if (clientModel)
    {
        ...
        if (mode != NT_FULL)
        {
            ...
            setWindowTitle(tr("HealthierthriceChain") + " - " + tr("Wallet") + ", " + sMode);
        };
...
#ifndef Q_OS_MAC
            qApp->setWindowIcon(QIcon(":icons/HealthierthriceChain_testnet"));
            setWindowIcon(QIcon(":icons/HealthierthriceChain_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/HealthierthriceChain_testnet"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("HealthierthriceChain client") + QString(" ") + tr("[testnet]"));
                trayIcon->setIcon(QIcon(":/icons/HealthierthriceChain_testnet"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("HealthierthriceChain client"));
    trayIcon->setIcon(QIcon(":/icons/HealthierthriceChain"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    connectionsIcon.setAttribute("data-title", tr("%n active connection(s) to HealthierthriceChain network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid HealthierthriceChain address or malformed URI parameters."));
    }
