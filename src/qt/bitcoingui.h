...
/**
  HealthierthriceChain GUI main class. This class represents the main window of the HealthierthriceChain UI. It communicates with both the client and
