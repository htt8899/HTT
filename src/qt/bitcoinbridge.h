#ifndef BITCOINBRIDGE_H
#define BITCOINBRIDGE_H
...
class BitcoinBridge : public QObject
{
    Q_OBJECT
...
public:
    explicit BitcoinBridge(BitcoinGUI *window, QObject *parent = 0);
    ~BitcoinBridge();
