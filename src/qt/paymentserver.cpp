...
const QString BITCOIN_IPC_PREFIX("HealthierthriceChain:");
...
{
    QString name("HealthierthriceChain");
...
PaymentServer::PaymentServer(QApplication* parent) : QObject(parent), saveURIs(true)
{
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start HealthierthriceChain: click-to-pay handler");
    else
